        ...
        <div
            ...
            <form action="{{ route('register') }}" method="POST" class="flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div
                        class="flex items-center bg-white/5 border border-primary/20 rounded-xl px-4 transition-all focus-within:border-primary focus-within:shadow-neon-sm">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div
                        ...
                        <button type="button"
                            class="flex items-center bg-transparent border-none text-white/40 cursor-pointer p-1 transition-colors hover:text-primary"
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mt-2">
                    ...
                    <a href="#" class="text-sm font-semibold text-primary transition-opacity hover:opacity-80">Lupa Kata
                        Sandi?</a>
                </div>
