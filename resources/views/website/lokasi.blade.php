...
@section('content')
        ...
        <div class="grid md:grid-cols-2 gap-6 items-start">
            ...
            <div
                ...
                <div class="flex gap-3 items-start">
                    ...
                    <div>
                        ...
                        <p class="text-white/50 text-xs leading-relaxed">Jl. R.A. Kartini No.44, Mangkukusuman, Kec. Tegal
                            Tim., Kota Tegal, Jawa Tengah 52131</p>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-col gap-1.5">
                            <div class="flex items-center gap-3 text-xs">
                                <span class="text-white/50">Setiap Hari</span>
                                <span class="text-white font-bold">14.00-01.00 WIB</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-auto pt-4 border-t border-white/[0.06]">
                    ...
                    <a href="https://wa.me/62283123456" target="_blank"
                        class="block w-full text-center bg-primary text-black font-bold text-sm uppercase tracking-wider px-4 py-3.5 rounded-lg transition-all hover:bg-primary-dark hover:shadow-neon">
                        HUBUNGI DI WHATSAPP
                    </a>
                </div>
            </div>
            ...
            <div class="rounded-2xl overflow-hidden min-h-[25rem] border border-primary/12">
                <iframe
                    ...
                    class="w-full h-full min-h-[25rem]" style="border:0;" allowfullscreen loading="lazy"
    ...
    <section class="px-6 pb-20 max-w-6xl mx-auto">
        <div class="flex flex-col md:flex-row items-start md:items-end justify-between gap-4 mb-6">
            ...
            <a href="#" class="text-primary text-sm font-semibold hover:opacity-80 transition whitespace-nowrap">Lihat Semua
                →</a>
        </div>
