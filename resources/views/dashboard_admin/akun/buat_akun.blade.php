...
<head>
    ...
    <title>Buat Akun Baru — Jay's Billiard</title>
    ...
    <div class="adm-layout">
        ...
        <main class="adm-main">
            @include('component.c_dashboard.topbar.topbar', [
                'topbar_title' => 'Buat Akun Baru',
                'topbar_sub' => 'Tambahkan pengguna atau admin ke sistem'
            ])
            ...
            <div class="adm-content">
                <div class="adm-breadcrumb" style="margin-bottom: 2rem; display: flex; align-items: center; gap: 0.5rem; font-size: 0.85rem; font-weight: 700; color: rgba(255,255,255,0.4);">
                    ...
                    <span>•</span>
                    <span style="color: #fff;">Buat Akun</span>
                </div>
                    ...
                    <form action="{{ route('admin.akun.store') }}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-input @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Contoh: John Doe" required>
                                @error('name') <span class="invalid-feedback">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group">
                                <label class="form-label">Username</label>
                                <input type="text" name="username" class="form-input @error('username') is-invalid @enderror" value="{{ old('username') }}" placeholder="Contoh: johndoe" required>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-input @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Contoh: john@example.com" required>
                                @error('email') <span class="invalid-feedback">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group">
                                <label class="form-label">Nomor Telepon</label>
                                <input type="text" name="phone" class="form-input @error('phone') is-invalid @enderror" value="{{ old('phone') }}" placeholder="Contoh: 08123456789">
                        ...
                        <div class="form-row" style="margin-top: 2rem;">
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-input @error('password') is-invalid @enderror" placeholder="Minimal 8 karakter" required>
                                @error('password') <span class="invalid-feedback">{{ $message }}</span> @enderror
                            </div>
                            <div class="form-group">
                                <label class="form-label">Konfirmasi Kata Sandi</label>
                                <input type="password" name="password_confirmation" class="form-input" placeholder="Ketik ulang password" required>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn-update">BUAT AKUN</button>
                        </div>
                    </form>
                </div>
            </div>
