                                    ...
                                    <div class="adm-menu-card-preview">
                                        ...
                                        <div class="preview-body">
                                            <div class="preview-header">
                                                <h3 class="preview-name" id="previewNameText">{{ $menu->name }}</h3>
                                                <div class="preview-status">
                                                    <span class="status-dot"></span>
                                                    {{ strtoupper($menu->status === 'available' ? 'Tersedia' : 'Kosong') }}
                                                </div>
                                            </div>
                                            <div class="preview-detail">
                                                <span class="detail-category" id="previewCatText">{{ strtoupper($menu->category) }}</span>
                                                <span class="detail-name">Lorem</span>
                                            </div>
                                            <p class="preview-desc" id="previewDescText">{{ $menu->description ?: '.Lorem ipsum dolor sit amet' }}</p>
                                        </div>
                        ...
                        <div class="adm-column-right">
                            ...
                            <div class="adm-inter-panel panel-status">
                                ...
                                <div class="adm-status-grid">
                                    <div class="adm-status-box available {{ $menu->status === 'available' ? 'active' : '' }}" onclick="setStatus('available', this)">
                                    ...
                                    <div class="adm-status-box unavailable {{ $menu->status === 'unavailable' ? 'active' : '' }}" onclick="setStatus('unavailable', this)">
                                        <div class="status-indicator"></div>
                                        <div class="status-text-wrap">
                                            <span class="status-dot-glow"></span>
                                ...
                                <input type="hidden" name="status" id="menuStatus" value="{{ $menu->status }}">
                            </div>
                            ...
                            <div class="adm-inter-panel panel-form">
                                ...
                                <div class="adm-form-group">
                                    ...
                                    <input type="text" name="name" id="inputName" class="adm-input" value="{{ $menu->name }}" required oninput="updatePreview()">
                                </div>
                                ...
                                <div class="adm-form-group">
                                    ...
                                    <textarea name="description" id="inputDesc" class="adm-textarea" oninput="updatePreview()">{{ $menu->description }}</textarea>
                                </div>
                            </div>
