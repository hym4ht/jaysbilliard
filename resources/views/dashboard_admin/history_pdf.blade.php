        ...
        <tbody>
            @foreach($bookings as $index => $booking)
                ...
                <tr>
                    ...
                    <td>
                        <span class="status-pill {{ in_array(strtolower($booking->status), ['completed', 'selesai', 'success']) ? 'selesai' : 'lunas' }}">
                            {{ in_array(strtolower($booking->status), ['completed', 'selesai', 'success']) ? 'Selesai' : 'Lunas' }}
                        </span>
                    </td>
                </tr>
            @endforeach
